...
void IF(){//fetch a new instruction from memory


}

void ID(){//decode the fetched instruction and read the register file
...
void MEM(){//access memory for load and store operations

}
void WB(){//write back the result to the register
